...
const Projects = () => {
    return ( 
        <section className="projects bg-slate-950 py-32 border-b-2 border-yellow-300" id="projects">
            <Title>Featured Projects</Title>
            <div className="projects-container grid grid-cols-12 gap-8 px-8 lg:px-16 py-16">
                <StyledProject data-aos='fade-up' className="col-start-1 col-end-13 sm:col-span-6 lg:col-span-4 h-[250px]
